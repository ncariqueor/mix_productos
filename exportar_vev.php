...
$query = "select estilo, dep, estacion, fecing, tempor, des, prenor, subdep, codmar, empujado_internet, reetiquetado, fecha_disp, fecha_foto, fecha_ficha, existe_internet  from vista_disp_vev where fecha = $fecha order by fecing asc";

$res = $mix->query($query);

$name = "Base_Mix_Productos_VeV" . $fecha . ".csv";
